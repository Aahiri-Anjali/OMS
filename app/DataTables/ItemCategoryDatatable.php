...
class ItemCategoryDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            // ->addColumn('action', 'itemcategorydatatable.action');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\ItemCategoryDatatable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ItemCategory $model)
    {
    ...
    {
        return $this->builder()
                    ->setTableId('itemcategorydatatable-table')
